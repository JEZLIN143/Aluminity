...
<body>
        ...
        ?>
                <div class="feedback-section">
                    ...
                    <div class="button-container">
                        <form method="post" action="declined_event.php">
                            <input type="hidden" name="feedback_id" value="<?php echo $row['id']; ?>">
                            <button type="submit" class="delete-button">Delete</button>
                        </form>
                        <form method="post" action="approval_connection.php">
                            <input type="hidden" name="feedback_id" value="<?php echo $row['id']; ?>">
                            <button type="submit" class="approve-button" onclick="approveEvent(this)">Approve</button>
                        </form>
                        <span class="badge" style="display:none;">Approved</span>
                    </div>
                </div>
        <?php
            }
    ...
    <script>
        function approveEvent(button) {
            button.style.display = "none"; // Hide the "Approve" button
            var badge = button.parentElement.querySelector(".badge");
            badge.style.display = "inline-block"; // Display the "Approved" badge
        }
    </script>
</body>
